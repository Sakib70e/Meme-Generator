...
function clearAll() {
  const memecon=document.querySelector('#memes');
  const jokecon=document.querySelector('#jokes');
  const quotecon=document.querySelector('#quotes');
  const riddcon=document.querySelector('#riddle');
  memecon.innerHTML='';
  jokecon.innerHTML='';
  quotecon.innerHTML='';
  riddcon.innerHTML='';
...
function showMeme() {
  ...
  me.setAttribute('src',randomMemeUrl);
  const mee=document.querySelector('#memes')
  clearAll();
  mee.appendChild(me);
}
...
function showJoke() {
  ...
  me.textContent=randomJokeText;
  const mee=document.querySelector('#jokes')
  clearAll();
  mee.appendChild(me);
}
...
function showQuote() {
  ...
  clearAll();
  const mee=document.querySelector('#quotes')
  mee.appendChild(quote);
  mee.appendChild(author);
}
...
function showRiddle() {
  ...
  const q=document.createElement('p');
   ...
   a.textContent="The answer is: "+answer;
  a.setAttribute('id','riddleans');
  a.hidden=true;
  clearAll();
  const mee=document.querySelector('#riddle');
  mee.appendChild(q);
  mee.appendChild(a);
}
...
function revealAnswers() {
  const el=document.querySelector("#riddle");
  const rid=el.querySelector('p');
  const ans=document.querySelector('#riddleans')
  if(rid && ans.hidden)
    ans.hidden=false;
  else if(rid)
    alert("Answer is already given");
  else
    alert("No riddle to display answer to")
}
